resource "aws_instance" "web_host11" {
...
resource "aws_s3_bucket" "flowbucket" {
  ...
  tags = merge({
    ...
    git_commit           = "c488d8359eb2220cbfc06cb969186f04f0094423"
    git_file             = "terraform/aws/ec2.tf"
    git_last_modified_at = "2024-05-15 12:30:35"
    git_last_modified_by = "93920286+avi-feder@users.noreply.github.com"
    git_modifiers        = "93920286+avi-feder/jonathan.jozwiak/nimrodkor"
    git_org              = "avi-feder"
    git_repo             = "terragoat"
